...
#define PLL_KP_GAIN                      2328
#define PLL_KI_GAIN                      103
...
#define PHASE1_FINAL_CURRENT           2177
/* Phase 2 */
#define PHASE2_DURATION                8002 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (4001*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT           2177
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (4001*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT           2177
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (4001*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT           2177
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (4001*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT           2177

#define ENABLE_SL_ALGO_FROM_PHASE      2
/* Sensor-less rev-up sequence */
#define STARTING_ANGLE_DEG             0  /*!< degrees [0...359] */
/* Observer start-up output conditions  */
#define OBS_MINIMUM_SPEED_RPM          3601
