...
#define PLL_KP_GAIN                      2234
#define PLL_KI_GAIN                      79
...
#define CORD_FIFO_DEPTH_UNIT            64  /*!< Depth of the FIFO used
                                                           to average mechanical speed
                                                           in dpp format */
#define CORD_MAX_ACCEL_DPPP              127  /*!< Maximum instantaneous
...
#define PID_TORQUE_KI_DEFAULT         2466
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2466
#define PID_FLUX_KI_DEFAULT           2466
...
#define PID_SPEED_KP_DEFAULT          2649/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          3027/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KD_DEFAULT          0/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
/* Speed PID parameter dividers */
#define SP_KPDIV                      2
#define SP_KIDIV                      32
#define SP_KDDIV                      16
#define SP_KPDIV_LOG                  LOG2((2))
...
#define CONSTANT1_Q                    72307
#define CONSTANT1_D                    72307
#define CONSTANT2_QD                   2257
