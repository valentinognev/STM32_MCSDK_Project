...
/*
 * It returns the Kp gain divisor as a power of 2
 */
...
/*
 * It returns the Ki gain divisor of the passed PI object as a power of 2
 */
...
/*
  * Returns the Kd gain divisor of the PID object passed
  */
uint16_t PID_GetKDDivisor(PID_Handle_t *pHandle);

/*
 * It returns the Kd gain divisor of the PID object passed as a power of 2
 */
