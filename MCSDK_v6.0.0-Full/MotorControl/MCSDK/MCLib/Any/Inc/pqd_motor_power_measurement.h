...
/* Updates the average electrical motor power measure with the latest values  of the DQ current and voltages. */
void PQD_CalcElMotorPower(PQD_MotorPowMeas_Handle_t *pHandle);

/* Clears the the s16 digit average motor power value stored in the handle */
