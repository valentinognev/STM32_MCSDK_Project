...
/**
  ...
  */
void ThreePwm_LoadNextStep( PWMC_ThreePwm_Handle_t * pHandle );
...
/**
  * It toggles the polarity of the timer PWM channel outputs
  */
void ThreePwm_SetOCOppositePolarity( PWMC_ThreePwm_Handle_t * pHandle );
...
/**
  ...
  */
void ThreePwm_TurnOnLowSides( PWMC_Handle_t * pHdl );
