...
/**
  ...
  */
void SixPwm_LoadNextStep( PWMC_SixPwm_Handle_t * pHandle );
...
/**
  ...
  */
void SixPwm_SetOCOppositePolarity( PWMC_SixPwm_Handle_t * pHandle );
...
/**
  ...
  */
void SixPwm_TurnOnLowSides( PWMC_Handle_t * pHdl );
