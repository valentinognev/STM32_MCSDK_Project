...
typedef struct
{
  MC_ControlMode_t Mode;   /*!< Modality of STC. It can be one of these two
                               settings: MCM_TORQUE_MODE to enable the
                               Torque mode or MCM_SPEED_MODE to enable the
                               Speed mode.*/
...
bool STC_ExecSin(SpeednTorqCtrl_Handle_t *pHandle, int16_t hMean, int16_t hAmp,  int32_t hPhase);
