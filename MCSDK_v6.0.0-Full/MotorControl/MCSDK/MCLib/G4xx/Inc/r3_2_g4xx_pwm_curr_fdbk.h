...
typedef const struct
{
  ...
  uint16_t Tsampling;                   /*!< It is the sampling time express in
                                            number of TIM clocks.*/
  uint16_t Tbefore;                   /*!< It is the sampling time express in
                                            number of TIM clocks.*/
  uint16_t Tcase2;                   /*!< It is the sampling time express in
                                            number of TIM clocks.*/
  uint16_t Tcase3;                   /*!< It is the sampling time express in
                                            number of TIM clocks.*/
...
/**
  ...
  */
void *R3_2_BRK2_IRQHandler(PWMC_R3_2_Handle_t *pHandle);

/**
  *  It contains the TIMx Break1 event interrupt
  */
void *R3_2_BRK_IRQHandler(PWMC_R3_2_Handle_t *pHandle);
