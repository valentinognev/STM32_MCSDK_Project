/**
  ******************************************************************************
  * @file    r3_2_f7xx_pwm_curr_fdbk.c
  ...
  *          topology is used.
  * 
  *          It is specifically designed for STM32F7XX
...
__weak void R3_2_Init( PWMC_R3_2_Handle_t * pHandle )
{
  ...
  if ( ( uint32_t )pHandle == ( uint32_t )&pHandle->_Super )
  {
    ...
    else
    {
      ...
      LL_ADC_INJ_SetTriggerSource(ADCx_1,LL_ADC_INJ_TRIG_EXT_TIM8_CH4);
	    LL_ADC_INJ_SetTriggerSource(ADCx_2,LL_ADC_INJ_TRIG_EXT_TIM8_CH4);
...
#pragma cstat_restore = "MISRAC2012-Rule-11.3"
  ...
  wAux = (int32_t)( pHandle->PhaseBOffset ) - (int32_t)(pHandle->pParams_str->ADCDataReg2[pHandle->_Super.Sector]->JDR1)*2;
