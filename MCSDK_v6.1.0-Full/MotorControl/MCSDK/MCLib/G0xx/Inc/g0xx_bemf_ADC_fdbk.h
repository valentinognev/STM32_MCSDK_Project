...
/** @addtogroup G0XX_Bemf_ADC_SpeednPosFdbk
  * @{
  */  
...
typedef struct
{
  ...
  uint16_t ADC1_DMA_converted[1]; /* Buffer used for DMA data transfer after the ADC conversion */
