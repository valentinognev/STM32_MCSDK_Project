/**
  ...
  *          implements the sensing using one ADC with DMA support.
...
/**
 * @defgroup G0XX_Bemf_ADC_SpeednPosFdbk Six-Step Sensorless with ADC Position Feedback
 *
 * @brief STM32G0, Sensorless Bemf acquisition with ADC implementation
 *
 * This component is used in applications based on an STM32G0 MCU
