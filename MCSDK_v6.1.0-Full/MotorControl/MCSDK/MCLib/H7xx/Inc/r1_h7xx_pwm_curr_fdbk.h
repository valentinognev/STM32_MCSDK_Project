/**
  ******************************************************************************
  * @file    r1_h7xx_pwm_curr_fdbk.h
  * @author  Motor Control SDK Team, ST Microelectronics
  * @brief   This file contains all definitions and functions prototypes for the
  *          R1_H7XX_pwm_curr_fdbk component of the Motor Control SDK.
  ******************************************************************************
  * @attention
  *
...
/*
 * @brief  parameters structure of the R1_H7XX_pwm_curr_fdbk Component.
 *
 */
typedef struct
{
 ...
 /* PWM generation parameters --------------------------------------------------*/
  ...
  uint16_t HTMin;                    /* */
  uint16_t CHTMin;                    /* */
  uint16_t Tbefore;  /* It is the sampling time express in number of TIM clocks.*/
  uint16_t Tafter;   /* It is the sum of dead time plus max
                        value between rise time and noise time
                        express in number of TIM clocks.*/
  uint16_t TSample;  /* It is the sampling time express in number of TIM clocks.*/
...
/** @addtogroup R1_H7XX_pwm_curr_fdbk
  * @{
  */
...
/**
  ...
  */
void R1F30X_TurnOnLowSides( PWMC_Handle_t * pHdl, uint32_t ticks );
