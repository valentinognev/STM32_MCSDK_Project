/**
  ******************************************************************************
  * @file    r3_2_h7xx_pwm_curr_fdbk.c
  ...
  *          topology is used.
  * 
  *          It is specifically designed for STM32H7XX microcontrollers and
...
{
  R3_2_OPAMPParams_t * OPAMPParams = pHandle->pParams_str->OPAMPParams;
