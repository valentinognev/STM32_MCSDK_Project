...
static void MX_TIM4_Init(void)
{
  ...
  */
  ...
  LL_TIM_IC_SetFilter(TIM4, LL_TIM_CHANNEL_CH1, M1_ENC_IC_FILTER);
  LL_TIM_IC_SetPolarity(TIM4, LL_TIM_CHANNEL_CH1, LL_TIM_IC_POLARITY_RISING);
  LL_TIM_IC_SetActiveInput(TIM4, LL_TIM_CHANNEL_CH2, LL_TIM_ACTIVEINPUT_DIRECTTI);
  LL_TIM_IC_SetPrescaler(TIM4, LL_TIM_CHANNEL_CH2, LL_TIM_ICPSC_DIV1);
  LL_TIM_IC_SetFilter(TIM4, LL_TIM_CHANNEL_CH2, M1_ENC_IC_FILTER);
...
static void MX_USART2_UART_Init(void)
{
  ...
  */
  ...
  /* USART2_RX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_2, LL_DMAMUX_REQ_USART2_RX);
  ...
  /* USART2_TX Init */
  LL_DMA_SetPeriphRequest(DMA2, LL_DMA_CHANNEL_3, LL_DMAMUX_REQ_USART2_TX);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetPinPull(M1_ENCODER_I_GPIO_Port, M1_ENCODER_I_Pin, LL_GPIO_PULL_NO);
