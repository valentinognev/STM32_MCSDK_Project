...
LL_GPIO_LockPin(PWM_IN_AMP_GPIO_Port, PWM_IN_AMP_Pin);
LL_GPIO_LockPin(PWM_IN_MEAN_GPIO_Port, PWM_IN_MEAN_Pin);
LL_GPIO_LockPin(PWM_IN_AZIMUTH_GPIO_Port, PWM_IN_AZIMUTH_Pin);
